  ...
  const handleDecline = () => {
    if (order && declineReason) {
      ...
      toast({
        ...
        description: `Order ${order.orderId} has been declined.`,
      });
      ...
      return (
        <div className="mt-4 space-y-4">
          <Alert className="bg-blue-50 border-blue-200 text-blue-800">
            ...
            <AlertDescription>
              Please wait while we look up order details for{' '}
              <strong>{orderIdFromUrl?.replace(ADMIN_PIN_SUFFIX, '')}</strong>...
            </AlertDescription>
          </Alert>
    ...
    if (!isLoading && orderIdFromUrl && !order) {
      return (
        <Alert variant="destructive" className="mt-4">
          ...
          <AlertDescription>
            No purchase order found with ID:{' '}
            <strong>{orderIdFromUrl?.replace(ADMIN_PIN_SUFFIX, '')}</strong>.
            ...
            <div className="flex-1">
              ...
              <CardContent className="p-0 pt-4 space-y-2 text-sm">
                ...
                <p className="flex justify-between">
                  <strong>Plan:</strong>{' '}
                  <span>
                    {order.planName} ({order.planPeriod})
                  </span>
                </p>
                <p className="flex justify-between">
                  <strong>Price:</strong> <span>{order.planPrice}</span>
                </p>
                <p className="flex justify-between">
                  ...
                  >
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          Please provide a short reason for declining this order.
            ...
            <Alert variant="destructive" className="mt-4">
              ...
              <AlertDescription>
                ...
                <p className="mt-2 text-xs">
                  If you believe this is a mistake, please contact us on +265 991
                  972 336.
                </p>
              </AlertDescription>
            </Alert>
