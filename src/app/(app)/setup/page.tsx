...
import { useBrandsoft, type BrandsoftConfig, type Invoice, type Company, type Quotation, type QuotationRequest, type Affiliate, type Transaction, type AdminSettings, type Plan } from '@/hooks/use-brandsoft';
