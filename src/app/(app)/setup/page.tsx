...
const initialCustomers: Customer[] = [
    { id: 'CUST-DEMO-0', name: 'John Banda', email: 'john.banda@creativeprints.mw', companyName: 'Creative Prints'},
    { id: 'CUST-DEMO-1', name: 'Jane Chirwa', email: 'jane.chirwa@bytesolutions.mw', companyName: 'Byte Solutions'},
    { id: 'CUST-DEMO-2', name: 'Mike Phiri', email: 'mike.phiri@maketesupplies.mw', companyName: 'Makete Supplies'},
    { id: 'CUST-DEMO-3', name: 'Grace Moyo', email: 'grace.moyo@buildright.mw', companyName: 'BuildRight Hardware'},
];
