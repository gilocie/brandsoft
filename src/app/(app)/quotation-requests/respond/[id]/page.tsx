...
export default function RespondToRequestPage() {
    ...
    const handleCreateQuotation = () => {
        ...
        router.push(`/quotations/new?products=${productQuery}&customerId=${requester.id}&senderId=${myCompanyId}&isRequest=true`);
    };

    return (
        <div className="container mx-auto space-y-6 py-8">
            <Button asChild variant="outline">
                <Link href="/quotation-requests?subtab=incoming"><ArrowLeft className="mr-2 h-4 w-4"/> Back to Requests</Link>
            </Button>
