...
import { useBrandsoft, type Customer, type Invoice, type Product } from '@/hooks/use-brandsoft';
...
export default function EditInvoicePage() {
  ...
  useEffect(() => {
    ...
    } else if (!isLoading) { // Only toast if we are done loading
  ...
  function onSubmit(data: InvoiceFormData) {
    ...
    toast({
        ...
        description: `Invoice ${invoiceToEdit.invoiceId} has been updated.`
    });
        ...
        <form onSubmit={e => e.preventDefault()} className="space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Note: Editing invoices with complex pre-existing items may require manual adjustment.</CardDescription>
            </CardHeader>
            <CardContent>
