...
// Admin Activation Key Formatting [BS-]= "Brandsoft" for [GSS-]= Go Save Site Company and [XXXXXXXX-XXXXXX] unique code given by system, if this type of code used then the user will have admin as its direct referral
// Activation Key Generated by admin = BS-GDT-XXXXXXXX-XXXXXX
// Affiliate Activation Key Formatting [BS-]= "Brandsoft" for [AFF-]= Affiliate and [XXXXXXXX-XXXXXX] unique staff ID code given by system, 
// Activation Key Generated by Staff = BS-AFF-67668370-BLVHWK 
