...
const initialAffiliateData: Affiliate = {
    ...
    clients: [
      { id: 'CLIENT-1', name: 'Client A', avatar: 'https://picsum.photos/seed/client1/100', plan: 'Standard', status: 'active', remainingDays: 25 },
      { id: 'CLIENT-2', name: 'Client B', avatar: 'https://picsum.photos/seed/client2/100', plan: 'Pro', status: 'active', remainingDays: 88 },
      { id: 'CLIENT-3', name: 'Client C', avatar: 'https://picsum.photos/seed/client3/100', plan: 'Standard', status: 'expired' },
      { id: 'CLIENT-4', name: 'Client D', avatar: 'https://picsum.photos/seed/client4/100', plan: 'Standard', status: 'active', remainingDays: 5 },
      { id: 'CLIENT-5', name: 'Client E', avatar: 'https://picsum.photos/seed/client5/100', plan: 'Pro', status: 'active', remainingDays: 120 },
      { id: 'CLIENT-6', name: 'Client F', avatar: 'https://picsum.photos/seed/client6/100', plan: 'Standard', status: 'expired' },
      { id: 'CLIENT-7', name: 'Client G', avatar: 'https://picsum.photos/seed/client7/100', plan: 'Standard', status: 'active', remainingDays: 15 },
      { id: 'CLIENT-8', name: 'Client H', avatar: 'https://picsum.photos/seed/client8/100', plan: 'Pro', status: 'active', remainingDays: 45 },
      { id: 'CLIENT-9', name: 'Client I', avatar: 'https://picsum.photos/seed/client9/100', plan: 'Standard', status: 'expired' },
      { id: 'CLIENT-10', name: 'Client J', avatar: 'https://picsum.photos/seed/client10/100', plan: 'Standard', status: 'active', remainingDays: 360 },
      { id: 'CLIENT-11', name: 'Client K', avatar: 'https://picsum.photos/seed/client11/100', plan: 'Pro', status: 'active', remainingDays: 2 },
